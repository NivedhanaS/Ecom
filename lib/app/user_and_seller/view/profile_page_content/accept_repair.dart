...
class _RepairRequestAcceptState extends State<RepairRequestAccept> {
                                          ...
                                          return InkWell(
                                            onTap: () {
                                              setState(() {
                                                ...
                                                serviceman_email= services.email;
                                              });
                                            },
  ...
  Future confirmAppointment(String user, String seller, String service, String rid, String address, String issue, String date, String time, BuildContext context) async {
    var postData = {'user': user, 'seller': seller, 'date': date, 'time': time, 'service': service, 'address': address, 'issue': issue, 'rid': int.parse(rid), 'phone': phone1.text,'serviceman_email':serviceman_email};
    // print(postData);
